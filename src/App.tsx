...
const authApi = AuthService as unknown as AuthSdk;
...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    const validateAccount = async () => {
      try {
        const isConnected = await authApi.checkAccount?.();
      ...
      <div className="relative mx-auto flex min-h-dvh max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <section className="flex flex-1 items-center justify-center py-12">
          {isCheckingAccount ? (
            ...
            <div className="w-full max-w-2xl rounded-[2rem] border border-slate-800 bg-slate-950/70 p-8 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.9)] backdrop-blur-sm sm:p-10">
